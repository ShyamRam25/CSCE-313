...
void worker_thread_function (FIFORequestChannel* chan, BoundedBuffer& request_buffer, BoundedBuffer& response_buffer, string filename, int m) {
...
int main (int argc, char* argv[]) {
    ...
    if (f == "") {
        ...
        for (int i = 0; i < w; i++) {
            ...
            string name(buf);
            FIFORequestChannel* temp = new FIFORequestChannel(name, FIFORequestChannel::CLIENT_SIDE);
