...
int main (int argc, char* argv[]) {
	...
	while (true) {
		...
		//dispacth a new thread to handle_process_loop
		thread thread_handle_process_loop(handle_process_loop, new_channel);
		//since the main thread is not blocked, it can accept more connections ( use detach instead of join)
		thread_handle_process_loop.detach();
